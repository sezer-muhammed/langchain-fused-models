...
class StructuredOutputHandler:
    ...
    def invoke_native(
        ...
        try:
            ...
            logger.debug("Successfully parsed native structured output")
            ...
            raise StructuredOutputError(
                f"Native structured output failed: {str(e)}", original_error=e
            )
    ...
    def invoke_with_parsing(
        ...
        try:
            ...
            logger.debug("Received response, extracting JSON")
            ...
            logger.debug("Successfully parsed structured output with fallback")
            ...
            raise StructuredOutputError(
                f"Failed to parse structured output: {str(e)}", original_error=e
            )
    ...
    def _parse_to_model(self, json_str: str, schema: Type[BaseModel]) -> BaseModel:
        ...
        try:
            ...
            raise StructuredOutputError(
                f"Failed to create model instance: {str(e)}", original_error=e
            )
